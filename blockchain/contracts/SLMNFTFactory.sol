...
contract SLMNFTFactory is Factory, Ownable {
    ...
    constructor(address nftAddress_, address tokenAddress_, uint randomNFTPrice_) {
        nftAddress = nftAddress_;
        tokenAddress = tokenAddress_;
        randomNFTPrice = randomNFTPrice_;
    ...
    function setRandomNFTPrice(uint randomNFTPrice_) public onlyOwner {
        randomNFTPrice = randomNFTPrice_;
    }

    function purchaseRandomNFT() public payable {
        SLMNFT slmNft = SLMNFT(nftAddress);
        slmNft.safeMint(msg.sender);
    }
